  ...
  <nav class="bg-white border-gray-200 dark:bg-gray-900 border-t-8">
    ...
    >
      <div class="flex flex-col md:flex-row md:items-center md:space-x-3">
        <div
          class="flex space-x-3 rtl:space-x-reverse items-center mb-2 md:mb-0"
        >
          <img src="/image/logo1.png" class="h-8" alt="logo" />
          <RouterLink class="self-center text-2xl pr-2" to="/"
            >Techsphere</RouterLink
          >
        </div>

        <div
          class="flex items-center md:border-l-2 pl-2 md:justify-center justify-start border-slate-300"
        >
          <p class="inline-flex">
            <svg
              class="w-6 h-6 mr-1 text-blue-800 dark:text-white"
              aria-hidden="true"
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        ...
        >
          <li>
            <RouterLink
              to="/"
              class="py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent inline-flex"
            >
              New Posts
            </RouterLink>
          </li>
