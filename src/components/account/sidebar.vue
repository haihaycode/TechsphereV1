<template>
    ...
    <!-- Sidebar -->
    <div id="docs-sidebar" :class="sidebarClasses">
      <div class="px-6">
  ...
  export default {
    ...
    data() {
      return {
        isMenuOpen: true,// Dữ liệu để theo dõi trạng thái sidebar
      };
    },
    computed: {
      sidebarClasses() {
        return {
          'hs-overlay': true,
          '--auto-close': 'lg',
          'hs-overlay-open:translate-x-0': this.isMenuOpen,
          '-translate-x-full': !this.isMenuOpen,
          'transition-all': true,
          'duration-300': true,
          'transform': true,
          ...
          'lg:block': true,
          'lg:translate-x-0': this.isMenuOpen,
          'lg:end-auto': true,
          'lg:bottom-0': true,
